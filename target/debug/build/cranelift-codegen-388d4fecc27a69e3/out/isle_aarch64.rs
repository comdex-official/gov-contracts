...
// - /Users/subham/gov-contracts/target/debug/build/cranelift-codegen-388d4fecc27a69e3/out/clif.isle
...
/// Internal type SideEffectNoResult: defined at src/prelude.isle line 466.
#[derive(Clone, Debug)]
...
/// Internal type ProducesFlags: defined at src/prelude.isle line 493.
#[derive(Clone, Debug)]
...
/// Internal type ConsumesFlags: defined at src/prelude.isle line 504.
#[derive(Clone, Debug)]
...
/// Internal type ALUOp: defined at src/isa/aarch64/inst.isle line 778.
...
/// Internal type ALUOp3: defined at src/isa/aarch64/inst.isle line 816.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum ALUOp3 {
    MAdd,
    MSub,
...
/// Internal type MoveWideOp: defined at src/isa/aarch64/inst.isle line 824.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum MoveWideOp {
    MovZ,
    MovN,
...
/// Internal type BitOp: defined at src/isa/aarch64/inst.isle line 862.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum BitOp {
    RBit,
    Clz,
...
/// Internal type FPUOp1: defined at src/isa/aarch64/inst.isle line 929.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FPUOp1 {
    Abs,
    Neg,
...
/// Internal type FPUOp2: defined at src/isa/aarch64/inst.isle line 939.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FPUOp2 {
    Add,
    Sub,
...
/// Internal type FPUOp3: defined at src/isa/aarch64/inst.isle line 950.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FPUOp3 {
    MAdd32,
    MAdd64,
...
/// Internal type FpuToIntOp: defined at src/isa/aarch64/inst.isle line 957.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FpuToIntOp {
    F32ToU32,
    F32ToI32,
...
/// Internal type IntToFpuOp: defined at src/isa/aarch64/inst.isle line 970.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum IntToFpuOp {
    U32ToF32,
    I32ToF32,
...
/// Internal type FpuRoundMode: defined at src/isa/aarch64/inst.isle line 984.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type VecExtendOp: defined at src/isa/aarch64/inst.isle line 997.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type VecALUOp: defined at src/isa/aarch64/inst.isle line 1014.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum VecALUOp {
    Sqadd,
    Uqadd,
...
/// Internal type VecMisc2: defined at src/isa/aarch64/inst.isle line 1093.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum VecMisc2 {
    Not,
    Neg,
...
/// Internal type VecRRLongOp: defined at src/isa/aarch64/inst.isle line 1150.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type VecRRNarrowOp: defined at src/isa/aarch64/inst.isle line 1165.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type VecRRRLongOp: defined at src/isa/aarch64/inst.isle line 1197.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type VecPairOp: defined at src/isa/aarch64/inst.isle line 1214.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum VecPairOp {
    Addp,
}

/// Internal type VecRRPairLongOp: defined at src/isa/aarch64/inst.isle line 1222.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type VecLanesOp: defined at src/isa/aarch64/inst.isle line 1233.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum VecLanesOp {
    Addv,
    Uminv,
...
/// Internal type VecShiftImmOp: defined at src/isa/aarch64/inst.isle line 1242.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AtomicRMWOp: defined at src/isa/aarch64/inst.isle line 1253.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AtomicRMWLoopOp: defined at src/isa/aarch64/inst.isle line 1268.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
pub fn constructor_side_effect<C: Context>(
    ...
    match pattern0_0 {
        ...
        &SideEffectNoResult::Inst2 {
            ...
            // Rule at src/prelude.isle line 477.
            let expr0_0 = C::emit(ctx, pattern1_0);
...
pub fn constructor_produces_flags_ignore<C: Context>(
    ...
    match pattern0_0 {
        ...
        &ProducesFlags::ProducesFlagsReturnsResultWithConsumer {
            ...
            // Rule at src/prelude.isle line 527.
            let expr0_0 = ProducesFlags::ProducesFlagsSideEffect {
                inst: pattern1_0.clone(),
            };
            return Some(expr0_0);
...
pub fn constructor_with_flags<C: Context>(
    ...
    match pattern0_0 {
        &ProducesFlags::ProducesFlagsSideEffect {
            ...
            match pattern2_0 {
                &ConsumesFlags::ConsumesFlagsReturnsReg {
                    ...
                    // Rule at src/prelude.isle line 559.
                    let expr0_0 = C::emit(ctx, pattern1_0);
                ...
                &ConsumesFlags::ConsumesFlagsTwiceReturnsValueRegs {
                    ...
                    // Rule at src/prelude.isle line 565.
                    let expr0_0 = C::emit(ctx, pattern1_0);
                    let expr1_0 = C::emit(ctx, pattern3_0);
                ...
                &ConsumesFlags::ConsumesFlagsFourTimesReturnsValueRegs {
                    ...
                    // Rule at src/prelude.isle line 577.
                    let expr0_0 = C::emit(ctx, pattern1_0);
                    let expr1_0 = C::emit(ctx, pattern3_0);
                    let expr2_0 = C::emit(ctx, pattern3_1);
        ...
        &ProducesFlags::ProducesFlagsReturnsResultWithConsumer {
            ...
            {
                // Rule at src/prelude.isle line 553.
                let expr0_0 = C::emit(ctx, pattern1_0);
                let expr1_0 = C::emit(ctx, pattern3_0);
...
pub fn constructor_with_flags_reg<C: Context>(
    ...
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/prelude.isle line 594.
...
pub fn constructor_operand_size<C: Context>(ctx: &mut C, arg0: Type) -> Option<OperandSize> {
    ...
    if let Some(pattern1_0) = C::fits_in_32(ctx, pattern0_0) {
        // Rule at src/isa/aarch64/inst.isle line 880.
...
pub fn constructor_fcmeq0<C: Context>(ctx: &mut C, arg0: Reg, arg1: &VectorSize) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/aarch64/inst.isle line 2085.
                ...
                &InstructionData::AtomicRmw {
                    ...
                    if let &Opcode::AtomicRmw = pattern5_0 {
                        ...
                        match pattern5_3 {
                            ...
                            &AtomicRmwOp::Smax => {
                                // Rule at src/isa/aarch64/lower.isle line 1287.
