...
/// Internal type Amode: defined at src/isa/x64/inst.isle line 768.
#[derive(Clone, Debug)]
pub enum Amode {
    ImmReg {
        simm32: u32,
...
/// Internal type ExtendKind: defined at src/isa/x64/inst.isle line 1365.
                                    ...
                                    } = &pattern8_0
                                    {
                                        if let &Opcode::Iconst = pattern9_0 {
                                            if let Some(pattern11_0) = C::simm32(ctx, pattern9_1) {
                                                ...
                                                if let Some(pattern12_0) = closure12() {
                                                    // Rule at src/isa/x64/inst.isle line 968.
                                                    let expr0_0 = Amode::ImmRegRegShift {
                                                        simm32: pattern12_0,
                                                        base: pattern1_1,
                                                        index: pattern1_2,
...
pub fn constructor_imm_i64<C: Context>(ctx: &mut C, arg0: Type, arg1: i64) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/x64/inst.isle line 1732.
