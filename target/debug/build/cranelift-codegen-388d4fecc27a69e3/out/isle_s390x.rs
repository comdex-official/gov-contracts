...
/// Internal type UnaryOp: defined at src/isa/s390x/inst.isle line 764.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum UnaryOp {
    Abs32,
    Abs64,
...
/// Internal type ShiftOp: defined at src/isa/s390x/inst.isle line 779.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum ShiftOp {
    RotL32,
    RotL64,
...
/// Internal type RxSBGOp: defined at src/isa/s390x/inst.isle line 792.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum RxSBGOp {
    Insert,
    And,
...
/// Internal type CmpOp: defined at src/isa/s390x/inst.isle line 801.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum CmpOp {
    CmpS32,
    CmpS32Ext16,
...
/// Internal type FPUOp1: defined at src/isa/s390x/inst.isle line 816.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FPUOp1 {
    Abs32,
    Abs64,
...
/// Internal type FPUOp2: defined at src/isa/s390x/inst.isle line 831.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FPUOp2 {
    Add32,
    Add64,
...
/// Internal type FPUOp3: defined at src/isa/s390x/inst.isle line 848.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FPUOp3 {
    MAdd32,
    MAdd64,
...
/// Internal type FpuToIntOp: defined at src/isa/s390x/inst.isle line 857.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum FpuToIntOp {
    F32ToU32,
    F32ToI32,
...
/// Internal type IntToFpuOp: defined at src/isa/s390x/inst.isle line 870.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum IntToFpuOp {
    U32ToF32,
    I32ToF32,
...
/// Internal type FpuRoundMode: defined at src/isa/s390x/inst.isle line 884.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type ProducesBool: defined at src/isa/s390x/inst.isle line 2333.
#[derive(Clone, Debug)]
...
pub fn constructor_i64_nonzero<C: Context>(ctx: &mut C, arg0: i64) -> Option<i64> {
    ...
    if let Some(pattern1_0) = closure1() {
        // Rule at src/isa/s390x/inst.isle line 950.
...
pub fn constructor_i64_not_neg1<C: Context>(ctx: &mut C, arg0: i64) -> Option<i64> {
    ...
    if let Some(pattern1_0) = closure1() {
        // Rule at src/isa/s390x/inst.isle line 955.
        return Some(pattern0_0);
    }
    return None;
}
...
pub fn constructor_mask_amt_reg<C: Context>(ctx: &mut C, arg0: Type, arg1: Reg) -> Option<Reg> {
    ...
    if let Some(pattern1_0) = C::gpr32_ty(ctx, pattern0_0) {
        let pattern2_0 = arg1;
        // Rule at src/isa/s390x/inst.isle line 1050.
        let expr0_0: i64 = -1;
                        ...
                        C::symbol_value_data(ctx, pattern4_1)
                    {
                        if let Some(()) = C::reloc_distance_near(ctx, pattern6_1) {
                            ...
                            if let Some(pattern10_0) = closure10() {
                                // Rule at src/isa/s390x/inst.isle line 1147.
                                let expr0_0 =
                                ...
                                C::symbol_value_data(ctx, pattern7_1)
                            {
                                if let Some(()) = C::reloc_distance_near(ctx, pattern9_1) {
                                    ...
                                    if let Some(pattern12_0) = closure12() {
                                        // Rule at src/isa/s390x/inst.isle line 1157.
                                        return Some(pattern0_0);
                                    }
                                }
                            }
...
pub fn constructor_unary_rr<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/s390x/inst.isle line 1450.
    let expr0_0 = C::temp_writable_reg(ctx, pattern0_0);
...
pub fn constructor_cmp_rsimm32<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/s390x/inst.isle line 1472.
...
pub fn constructor_loadrev16<C: Context>(ctx: &mut C, arg0: &MemArg) -> Option<Reg> {
    let pattern0_0 = arg0;
    // Rule at src/isa/s390x/inst.isle line 1522.
    let expr0_0: Type = I32;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_loadrev32<C: Context>(ctx: &mut C, arg0: &MemArg) -> Option<Reg> {
    let pattern0_0 = arg0;
    // Rule at src/isa/s390x/inst.isle line 1529.
    let expr0_0: Type = I32;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_emit_insert_imm<C: Context>(
    ...
    if let Some(pattern2_0) = C::uimm32shifted_from_u64(ctx, pattern1_0) {
        // Rule at src/isa/s390x/inst.isle line 1940.
    ...
    if let Some(pattern2_0) = C::gpr32_ty(ctx, pattern1_0) {
        if let Some(pattern3_0) = C::sinkable_inst(ctx, pattern0_0) {
            ...
            } = &pattern4_0
            {
                if let &Opcode::Load = pattern5_0 {
                    if let Some(()) = C::bigendian(ctx, pattern5_2) {
                        // Rule at src/isa/s390x/inst.isle line 2182.
                        let expr0_0 = constructor_sink_load(ctx, pattern3_0)?;
        ...
        // Rule at src/isa/s390x/inst.isle line 2184.
        let expr0_0 = C::put_in_reg(ctx, pattern0_0);
...
pub fn constructor_put_in_regpair_lo_sext64<C: Context>(
    ...
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/s390x/inst.isle line 2216.
    let expr0_0 = constructor_copy_writable_regpair(ctx, pattern1_0)?;
    let expr1_0 = constructor_writable_regpair_lo(ctx, &expr0_0)?;
...
pub fn constructor_trap_if_bool<C: Context>(
    ...
    {
        let pattern2_0 = arg1;
        // Rule at src/isa/s390x/inst.isle line 2393.
        let expr0_0 = constructor_emit_producer(ctx, pattern1_0)?;
...
pub fn constructor_casloop_rotate_result<C: Context>(
    ...
    if pattern0_0 == I16 {
        ...
        if let Some(()) = C::bigendian(ctx, pattern2_0) {
            let pattern4_0 = arg2;
            let pattern5_0 = arg3;
            // Rule at src/isa/s390x/inst.isle line 2503.
            let expr0_0: Type = I32;
            let expr1_0: u8 = 16;
...
pub fn constructor_lshr_imm<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/s390x/inst.isle line 2933.
    let expr0_0 = constructor_shiftop_lshr(ctx, pattern0_0)?;
    let expr1_0 = C::zero_reg(ctx);
    let expr2_0 = constructor_shift_rr(ctx, pattern0_0, &expr0_0, pattern1_0, pattern2_0, expr1_0)?;
    return Some(expr2_0);
...
pub fn constructor_icmpu_mem_zext16<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/s390x/inst.isle line 3272.
